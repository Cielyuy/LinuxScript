...
#Specified_Dir = "0712" + '/'  ###############指定储存复制文件的特定文佳夹
    Specified_Dir_preffix_1 = "0716_V-85_2"                        ###########!!!!!!!!!!
    Specified_Dir_preffix_2 = '/v85' + '_'                           ###########!!!!!!!!!!!
    ...
    B_J_Content_Preffix = 'call fluent 3ddp -t32 -g -i '
    ...
    linux_content_preffix_1 = 'fluent  -g  3d  -t16 -cnf=$hostlist   -mpi=intel -i '
